...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prolab

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prolab: ${OBJECTFILES}
...
${OBJECTDIR}/models.o: models.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models.o models.c
...
${OBJECTDIR}/teamlist.o: teamlist.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/teamlist.o teamlist.c

${OBJECTDIR}/warmechanics.o: warmechanics.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/warmechanics.o warmechanics.c
